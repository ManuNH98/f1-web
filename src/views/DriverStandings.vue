    ...
    <div class="dark:bg-dark dark:text-white p-10">
      ...
      <div class="p-5">
        <div class="grid grid-cols-3 gap-10">
            <div v-for="(driver, id) in drivers" :key="id" class="pt-10 pr-7 pl-7 text-center border-t-2 border-r-2 border-l-2 rounded-t-md dark:border-white hover:scale-105 duration-300" :class="getTeamColorHover(driver.Constructors[0].constructorId)">
              <router-link :to="{ name: 'Driver-Details', params: {id: driver.Driver.driverId}}">
